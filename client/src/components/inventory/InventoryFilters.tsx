      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 pr-10 h-12 rounded-xl border-2 bg-white shadow-sm focus:shadow-md transition-all duration-200"
          />
          {searchTerm && (
            <Button
              variant="ghost"
        ...
        <div className="flex gap-3">
          <Select value={selectedCategory} onValueChange={onCategoryChange}>
            <SelectTrigger className="flex-1 h-12 rounded-xl border-2 bg-white shadow-sm">
              <div className="flex items-center gap-2">
                <Filter className="w-4 h-4 text-purple-600" />
                <SelectValue placeholder="Category" />
              </div>
            </SelectTrigger>
            <SelectContent className="rounded-xl bg-white shadow-xl border-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          ...
          <div className="md:col-span-1 relative group">
            ...
            <Input
              ...
              value={searchTerm}
              onChange={(e) => onSearchChange(e.target.value)}
              className="pl-12 h-12 rounded-xl border-2 bg-white shadow-sm hover:shadow-md focus:shadow-lg transition-all duration-200 focus:border-primary/50 focus:ring-2 focus:ring-primary/20"
            />
            {searchTerm && (
              <Button
                variant="ghost"
          ...
          <Select value={selectedCategory} onValueChange={onCategoryChange}>
            <SelectTrigger className="h-12 rounded-xl border-2 bg-white shadow-sm hover:shadow-md transition-all duration-200 focus:border-primary/50">
              <div className="flex items-center gap-2">

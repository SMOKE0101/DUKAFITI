...
const EnhancedSidebar: React.FC<EnhancedSidebarProps> = ({ 
  ...
  return (
    <div className={`hidden lg:block ${className}`}>
      <div 
        className={cn(
          "fixed left-0 top-16 h-[calc(100vh-4rem)] border-r flex flex-col z-40 shadow-xl",
      ...
      >
        {/* Brand Section - Professional design with proper dark mode */}
        <div className={cn(
        ...
        {/* Navigation Links - Enhanced animations with dark mode */}
        <nav className={cn(
          ...
          {navigation.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Enhanced Tooltip for collapsed state with dark mode */}
                {isCollapsed && (
        ...
        {/* Bottom Section - Logout with dark mode */}
        <div className={cn(
        ...
        {/* Enhanced Toggle Button with dark mode */}
        <div className={cn(

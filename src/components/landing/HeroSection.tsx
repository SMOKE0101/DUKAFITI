      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left" data-scroll-trigger>
            {/* Brand Badge */}
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-purple-600/20 to-blue-500/20 backdrop-blur-sm border border-purple-500/30 rounded-full px-4 sm:px-6 py-3 sm:py-4">
            ...
            {/* Main Headline with DUKAFITI Branding */}
            <div className="space-y-4 sm:space-y-6">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="block text-white">Transform Your</span>
                <span className="block text-white">Kenyan Shop with</span>
                <div className="block mt-4">
                  <DukafitiBrand 
                    size="xl" 
                    layout="horizontal"
                    textColor="bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 bg-clip-text text-transparent"
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                <span className="italic text-blue-300 font-medium">"Dukubora ni DUKAFITI"</span> - 
                Say goodbye to pen and paper. Track inventory, manage customers, process M-Pesa payments, 
                and grow your business with Kenya's most trusted shop management system.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start pt-4">
              <Button 
                ...
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-8 py-4 text-lg rounded-xl shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105 border-0"
              >
              ...
              <Button 
                ...
                className="border-2 border-blue-500 text-blue-300 hover:bg-blue-500/10 hover:text-white px-8 py-4 text-lg rounded-xl transition-all duration-300"
              >
          ...
          <div className="relative mt-8 lg:mt-0" data-scroll-trigger>
            ...
            <div className="relative mx-auto max-w-sm lg:max-w-lg">
              {/* Gradient Background */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600/30 to-purple-500/30 rounded-3xl blur-3xl transform rotate-6 animate-pulse" />
              ...
              <div className="relative bg-slate-900 rounded-3xl border-4 border-slate-700 shadow-2xl overflow-hidden transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-6">
                  {/* Status Bar with DUKAFITI Brand */}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-4">
                      ...
                      <p className="text-blue-100 text-2xl font-bold">KSh 24,500</p>
                      <p className="text-blue-200 text-sm">+15% from yesterday</p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between items-center bg-slate-700/50 rounded-lg p-3">
                        ...
                        <p className="text-blue-400 font-semibold">KSh 250</p>
                      </div>
                      <div className="flex justify-between items-center bg-slate-700/50 rounded-lg p-3">
                        <div>
                        ...
                        <p className="text-blue-400 font-semibold">KSh 120</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 bg-blue-500 text-white rounded-full p-3 shadow-lg animate-bounce">

...
const EditCustomerModal: React.FC<EditCustomerModalProps> = ({
  ...
  return (
    <MobileOptimizedModal
      ...
      className="w-[95vw] max-w-md border-2 border-blue-600 rounded-xl bg-white dark:bg-gray-900"
      footer={
    ...
    >
      ...
      <form id="edit-customer-form" onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
